...
for i in `seq 1 $nombrePartitions`;
	do
		...
		python VectorisationSegmentsVSO.py $corpus_train ./../Lexiques/pos.txt ./../Lexiques/negat.txt ./../Lexiques/neut.txt ./../Lexiques/MotsVides.txt
		echo 'train fait'
		python VectorisationSegmentsVSO.py $corpus_test ./../Lexiques/pos.txt ./../Lexiques/negat.txt ./../Lexiques/neut.txt ./../Lexiques/MotsVides.txt		
		echo 'test fait'
#		python VectorisationSegments.py $corpus_test ./../Lexiques/Positif.txt ./../Lexiques/Negatif.txt ./../Lexiques/Opinion.txt ./../Lexiques/MotsVides.txt ./../Lexiques/LabelTreeTagger.txt ./../Lexiques/LabelFctSyntaxTalismane.txt ./../Lexiques/LabelChuncksSEM.txt ./../Lexiques/LabelENSEM.txt
		...
		corpus_train_vect='./../CORPUS/TRAIN/'$i'_train_tfidf.txt' 
		corpus_test_vect='./../CORPUS/TEST/'$i'_test_tfidf.txt'
