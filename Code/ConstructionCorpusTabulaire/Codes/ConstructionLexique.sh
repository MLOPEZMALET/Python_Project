...
java -Xmx1G -jar -Dconfig.file=talismane-fr-3.0.0b.conf talismane-core-3.0.0b.jar encoding=UTF8 tokenFilters="./filters_token/identifiant.txt" inFile=./../../ima/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/$corpus'.txt' outFile=./../../ima/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/$corpus'_talismane.conll'
cd ./../../ima/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/
