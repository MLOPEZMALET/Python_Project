...
java -Xmx1G -jar -Dconfig.file=talismane-fr-3.0.0b.conf talismane-core-3.0.0b.jar encoding=UTF8 tokenFilters="./filters_token/identifiant.txt" inFile=./../../mma/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/$corpus'.txt' outFile=./../../mma/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/$corpus'_talismane.conll'
cd ./../../mma/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/
...
./sem tagger ./resources/master/fr/np_chunking_ad.xml ./../../mma/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/$corpus'_vect.conll' -o ./../../mma/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/
cd ./../../mma/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/
...
cd ./../../../../outils/SEM-master/
./sem tagger ./resources/master/fr/NER.xml ./../../mma/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/$corpus'_vect.conll' -o ./../../mma/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/
cd ./../../mma/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/
# On renomme le fichier de sortie de SEM
...
echo '\n--> Renommage de aggregation_talismane_sem_'$corpus'_vect.conll en '$corpus'.conll'
...
echo 'depRel_'$corpus'.conll --> tt_depRel_'$corpus'.conll'
...
./tree-tagger ./../lib/french.par ./../../../mma/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/'pourTT_depRel_'$corpus'.conll' ./../../../mma/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/'tte_depRel_'$corpus'.conll' -token
./tree-tagger ./../lib/spoken-french.par ./../../../mma/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/'pourTT_depRel_'$corpus'.conll' ./../../../mma/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/'tto_depRel_'$corpus'.conll' -token
cd ./../../../mma/V2/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/
python ./Codes/ReunificationPOStag_TreeTagger.py 'depRel_'$corpus'.conll' 'tte_depRel_'$corpus'.conll' 'tto_depRel_'$corpus'.conll' 'pourTT_depRel_'$corpus'.conll'
cp 'tt_depRel_'$corpus'.conll' 'save_TreeTagger.conll'
# suppression des fichiers intermédiaires
rm 'tte_depRel_'$corpus'.conll'
rm 'tto_depRel_'$corpus'.conll'
#rm 'pourTT_depRel_'$corpus'.conll'
if [ -f ./'tt_depRel_'$corpus'.conll' ]; then
	echo "${vert}--> Terminé.${reset}"
else
	echo "${rouge}--> ERREUR.${reset}"
fi
...
# Le corpus contient :
# IdToken - Token - Lemme - POS-tag Talismane - IdAbsTeteSyntax - IdRelTeteSyntax - FctSyntax - POS SEM - Chunck SEM - Entités Nommées SEM
# POS-tag TreeTagger Ecrit - POS-tag TreeTagger Oral - Lexique (x10)
...
python ./Codes/InfoTeteSyntaxique.py 'lex_tt_depRel_'$corpus'.conll'
...
echo '\n--> Renommage de en_id_pos_head_lex_tt_depRel_'$corpus'.conll en '$corpus'.conll'
...
# --> RENOMMANGE DE LA SORTIE DU PROGRAMME
echo "\n${bleu}• Renommange du fichier de sortie en "$corpus".conll... ${reset}"
