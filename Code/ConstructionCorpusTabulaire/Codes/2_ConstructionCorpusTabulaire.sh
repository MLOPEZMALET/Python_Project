...
java -Xmx1G -jar -Dconfig.file=talismane-fr-3.0.0b.conf talismane-core-3.0.0b.jar encoding=UTF8 tokenFilters="./filters_token/identifiant.txt" inFile=./../../vso/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/$corpus'.txt' outFile=./../../vso/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/$corpus'_talismane.conll'
cd ./../../vso/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/
...
./sem tagger ./resources/master/fr/np_chunking_ad.xml ./../../vso/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/$corpus'_vect.conll' -o ./../../vso/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/
cd ./../../vso/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/
...
cd ./../../../outils/SEM-master/
./sem tagger ./resources/master/fr/NER.xml ./../../vso/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/$corpus'_vect.conll' -o ./../../vso/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/
cd ./../../vso/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/
# On renomme le fichier de sortie de SEM
...
python ./Codes/VectoriserCorpusComplet_TreeTagger.py 'depRel_'$corpus'.conll' 'tt_depRel_'$corpus'.conll'
...
./tree-tagger ./../lib/french.par ./../../../vso/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/'tt_depRel_'$corpus'.conll' ./../../../vso/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/'tte_depRel_'$corpus'.conll' -token
./tree-tagger ./../lib/spoken-french.par ./../../../vso/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/'tt_depRel_'$corpus'.conll' ./../../../vso/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/'tto_depRel_'$corpus'.conll' -token
cd ./../../../vso/Segmentation_thematique_CRF/ConstructionCorpusTabulaire/

echo 'depRel_'$corpus'.conll, tte_depRel_'$corpus'.conll, tto_depRel_'$corpus'.conll => lex_tt_depRel_'$corpus'.conll'
...
# --> RENOMMAGE DE LA SORTIE DU PROGRAMME
echo "\n${bleu}• Renommage du fichier de sortie en "$corpus".conll... ${reset}"
